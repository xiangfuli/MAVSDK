...
#include "hil_gps/hil_gps_service_impl.h"
#endif
...
#ifdef HIL_GPS_ENABLED
    _hil_gps_lazy_plugin(mavsdk),
    _hil_gps_service(_hil_gps_lazy_plugin),
#endif
...
private:
    ...
    LazyPlugin<HilGps> _hil_gps_lazy_plugin;

    HilGpsServiceImpl<> _hil_gps_service;
#endif
